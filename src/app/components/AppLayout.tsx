...
import { FaTachometerAlt, FaQuestionCircle, FaMicrophone, FaRegFileAudio, FaSignOutAlt, FaImage, FaTable } from 'react-icons/fa';
...
const navLinks = [
  ...
  { name: 'Table Detection', href: '/table-detect', icon: FaTable },
];
